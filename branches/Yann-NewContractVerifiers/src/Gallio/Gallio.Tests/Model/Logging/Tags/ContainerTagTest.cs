...
namespace Gallio.Tests.Model.Logging.Tags
{
    ...
    {
        [ContractVerifier]
        public readonly IContractVerifier EqualityTests = new EqualityContractVerifier<ContainerTag>()
        {
        ...
        private static readonly EquivalenceClassCollection<ContainerTag> equivalenceClasses
