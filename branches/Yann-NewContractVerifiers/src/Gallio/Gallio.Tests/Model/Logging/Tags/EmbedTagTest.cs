...
namespace Gallio.Tests.Model.Logging.Tags
{
    ...
    {
        [ContractVerifier]
        public readonly IContractVerifier EqualityTests = new EqualityContractVerifier<EmbedTag>()
        {
        ...
        private static readonly EquivalenceClassCollection<EmbedTag> equivalenceClasses
