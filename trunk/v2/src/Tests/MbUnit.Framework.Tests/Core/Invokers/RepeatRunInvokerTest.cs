...
namespace MbUnit.Framework.Tests.Core.Invokers
{
    ...
    /// </summary>
    [TestFixture]
    public class RepeatRunInvokerTest
    {
        [Test]
        [ExpectedException(typeof(ArgumentException))]
        public void CountNegative()
        {
            new RepeatRunInvoker(new MockRunInvoker(), -1);
        }
        ...
        {
            new RepeatRunInvoker(new MockRunInvoker(), 0);
        }
        ...
        public void CallTwoTimes()
        {
            ...
            RepeatRunInvoker invoker = new RepeatRunInvoker(methodRun, 2);
