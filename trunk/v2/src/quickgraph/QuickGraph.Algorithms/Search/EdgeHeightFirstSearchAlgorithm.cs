...
namespace QuickGraph.Algorithms.Search
{
	...
	/// </summary>
	public class EdgeHeightFirstSearchAlgorithm :
		IAlgorithm
		...
		,IEdgeColorizerAlgorithm
	{
		...
		public EdgeHeightFirstSearchAlgorithm(
		...
		/// <summary>
		/// Gets the <see cref="IBidirectionalVertexAndEdgeListGraph"/> visited graph
		/// </summary>
		/// <value>
		/// The <see cref="IBidirectionalVertexAndEdgeListGraph"/> visited graph
		/// </value>
