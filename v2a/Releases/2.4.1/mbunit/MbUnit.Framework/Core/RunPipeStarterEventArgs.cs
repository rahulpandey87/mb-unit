...
namespace MbUnit.Core
{
	...
	/// </summary>
	public class RunPipeStarterEventArgs  : EventArgs
	{
		private RunPipeStarter starter;
	...
	public delegate void RunPipeStarterEventHandler(Object sender, 
		RunPipeStarterEventArgs e);
}
