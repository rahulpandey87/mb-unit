...
namespace MbUnit.Tests.Core.Filters
{
	...
	public class FixtureFilterFactory
	{
        ...
        public NamespaceFixtureFilter Namespace
        {
			get
			{
				return FixtureFilters.Namespace("MbUnit.Tests.Core.Filters");
			}
		}
        ...
        public TypeFixtureFilter Type
        {
			get
			{
				return FixtureFilters.Type("MbUnit.Tests.Core.Filters.DummyFixture");
			}
		}
