...
namespace Gallio.Tests.Model.Logging.Tags
{
    ...
    {
        [ContractVerifier]
        public readonly IContractVerifier EqualityTests = new EqualityContractVerifier<Tag>()
        {
        ...
        private static readonly EquivalenceClassCollection<Tag> equivalenceClasses
