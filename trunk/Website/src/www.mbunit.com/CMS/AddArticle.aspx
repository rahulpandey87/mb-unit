...
<asp:Content ID="Content1" ContentPlaceHolderID="contentPlaceHolder" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues"
        ConnectionString="<%$ ConnectionStrings:mbunitDBConnectionString1 %>" DeleteCommand="DELETE FROM [Articles] WHERE [ID] = @original_ID AND [Title] = @original_Title AND [Text] = @original_Text AND [Link] = @original_Link AND [Created] = @original_Created AND [Author] = @original_Author"
