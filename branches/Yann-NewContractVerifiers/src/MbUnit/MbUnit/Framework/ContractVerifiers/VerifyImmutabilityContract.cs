...
namespace MbUnit.Framework.ContractVerifiers
{
    ...
    public class VerifyImmutabilityContract<TTarget> : AbstractContractVerifier
    {
        ...
        public override IEnumerable<ContractVerifierPattern> GetContractPatterns()
        {
            ...
            // Is there any public property setter?
            //yield return new MemberRecursionPatternBuilder<TTarget, PropertyInfo>()
            //    .SetName("HasNoPublicPropertySetter")
            //    .SetBindingFlags(BindingFlags.Instance | BindingFlags.Public)
            //    .SetAssertionFunction(propertyInfo =>
            //    {
            //        if (propertyInfo.GetSetMethod() == null)
            //            return null;

            //        return new AssertionFailureBuilder("Expected the property to have no public setter.")
            //            .AddRawLabeledValue("Declaring Type", propertyInfo.DeclaringType)
            //            .AddRawLabeledValue("Property Type", propertyInfo.PropertyType)
            //            .AddRawLabeledValue("Property Name", propertyInfo.Name)
            //            .ToAssertionFailure();
            //    })
            //    .ToPattern();
        }
