...
namespace MbUnit.Core.Framework 
{
	...
	/// </summary>
	/// <include file="MbUnit.Framework.Doc.xml" path="doc/remarkss/remarks[@name='NonTestPatternAttribute']"/>
	[AttributeUsage(AttributeTargets.Method, AllowMultiple=false, Inherited=true)]
	public class NonTestPatternAttribute :  PatternAttribute
	{
		public NonTestPatternAttribute()
		{}
		
		public NonTestPatternAttribute(string description)
			:base(description)
		{}
	}
}
