...
namespace MbUnit.Core.Reports.Serialization
{
    ...
    {
        private ReportSetUpAndTearDown setUpAndTearDown;
        ...
        public ReportSetUpAndTearDown SetUpAndTearDown
        {
            get
            {
                return this.setUpAndTearDown;
            }
        }
    }

    public delegate void ReportSetUpAndTearDownEventHandler(object sender,
