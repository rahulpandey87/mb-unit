...
namespace Gallio.Tests.Model.Logging.Tags
{
    ...
    {
        [ContractVerifier]
        public readonly IContractVerifier EqualityTests = new EqualityContractVerifier<SectionTag>()
        {
        ...
        private static readonly EquivalenceClassCollection<SectionTag> equivalenceClasses
