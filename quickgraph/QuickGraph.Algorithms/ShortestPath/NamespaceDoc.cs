...
namespace QuickGraph.Algorithms.ShortestPath
{
	...
	/// <see cref="DijkstraShortestPathAlgorithm"/>. 
	/// </para>
	/// <para>If all the wieghts are
	/// equal to 1, the <see cref="QuickGraph.Algorithms.Search.BreadthFirstSearchAlgorithm"/>
	/// is more efficient to use.
	/// </para>
	/// <para>
	/// If the weights can be negavite, 
	/// use the <see cref="QuickGraph.Algorithms.ShortestPath.BellmanFordShortestPathAlgorithm"/>.
	/// </para>
	/// </summary>
