...
namespace MbUnit.Core
{
    public interface IFixtureRunner
    {
        ...
        event ReportSetUpAndTearDownEventHandler TestFixtureSetUp;
        event ReportSetUpAndTearDownEventHandler TestFixtureTearDown;
        event ReportRunEventHandler RunResult;

        void Run(FixtureExplorer explorer, ReportListener listener);
    }
}
